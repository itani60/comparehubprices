...
function initializeCategoriesDropdown() {
    ...
    // This script is shared across multiple pages; if a page doesn't include the 3-column
    // categories dropdown markup, skip initialization to avoid runtime errors.
    if (!categoryItems.length || !subcategoryTitle || !subcategoryContent || !subSubcategoryTitle || !subSubcategoryContent) {
        console.debug('initializeCategoriesDropdown: required elements not found, skipping');
        return;
    }
